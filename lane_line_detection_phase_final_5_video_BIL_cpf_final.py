...
def canny(img):
    ...
    canny_image= cv2.Canny(filtered_image,10,50)
    return canny_image
...
#t = 0
#total_time = 0
cap = cv2.VideoCapture("D_R_3_Trim.mp4")
#out = cv2.VideoWriter('D_R_3_Trim_cpf_final_5_out.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10,(1056,594))
...
while(True):
    ...
    if ret==True:
        ...
        cv2.imwrite('DR3_Trim_cpf_final_5_canny_10_50_'+str(i)+'.jpg',canny_image)
